...
function getScale () {
  ...
  if ((autoScaleInfo.innerWidth / autoScaleInfo.innerHeight) > 1) {
    ...
    document.body.style.transform = 'rotate(90deg) translate(0, ' + -autoScaleInfo.innerWidth + 'px)'
    document.body.style.height = autoScaleInfo.innerWidth + 'px'
    document.body.style.width = autoScaleInfo.innerHeight + 'px'
