var animate = function() {
  ...
  var k = function(a) {
    ...
    G = {
      ...
      easeInElastic: function(a, c, b, d) {
        ...
        return -(b * Math.pow(2, 10 * --a) * Math.sin(2 * (a * d - f) * Math.PI / e)) + c
      },
      ...
      easeOutElastic: function(a, c, b, d) {
        ...
        return b * Math.pow(2, -10 * a) * Math.sin(2 * (a * d - (b < Math.abs(b) ? e / 4 : e / (2 * Math.PI) * Math.asin(b / b))) * Math.PI / e) + b + c
      },
      ...
      easeInOutElastic: function(a, c, b, d) {
        ...
        var e = d * (1 - Math.min(e, 999) / 1E3) * 1.5,
          f = b < Math.abs(b) ? e / 4 : e / (2 * Math.PI) * Math.asin(b / b);
        return 1 > a ? -.5 * b * Math.pow(2, 10 * --a) * Math.sin(2 * (a * d - f) * Math.PI / e) + c : b * Math.pow(2, -10 * --a) * Math.sin(2 * (a * d - f) * Math.PI / e) * .5 + b + c
      },
      easeInOutBack: function(a, c, b, d) {
        var e = 1.70158;
        return 1 > (a /= d / 2) ? b / 2 * a * a * (((e *= 1.525) + 1) * a - e) + c : b / 2 * ((a -= 2) * a * (((e *= 1.525) + 1) * a + e) + 2) + c
      }
    },
    y = function(a) {
      return a[0]
    ...
    z = function(a) {
      for (var c = arguments.length, b = Array(1 < c ? c - 1 : 0), d = 1; d < c; d++) b[d - 1] = arguments[d];
      var e = H(b);
    ...
    B = function(a) {
      a = "string" == typeof a ? /^[\#.]?[\w-]+$/.test(a) ? "." == a[0] ? document.getElementsByClassName(a.slice(1)) : "#" == a[0] ? document.getElementById(a.slice(1)) : document.getElementsByTagName(a) : document.querySelectorAll(a) : a;
      return Array.isArray(a) ? a : a.nodeType ? [a] : a instanceof NodeList || a instanceof HTMLCollection ? [].concat(F(a)) : a.get()
    },
    m = new Map;
  ...
  var L = function() {
    ...
    E = function(a) {
      ...
      v(a).forEach(function(a) {
        return c.set(a, c.get(a).slice().reverse())
      });
      return c
    },
    P = r(I, L, M, N, O, function(a) {
      var c = h(a);
      c.set("el", B(a.get("el")));
      return c
    }, function(a) {
    ...
    R = function() {
      var a = r(y, A),
        c = k(function(b, c) {
          ...
          /\d$/.test(b.get("easing")) ? (f = b.get("easing").split(" "), g = f[1], e.set("easing", f[0]), e.set("frequency", g)) : e.set("easing", b.get("easing"));
          return e
        });
      return function(a, d) {
        return v(a).map(c(a))
  ...
  var u = function() {
    ...
    Q = function() {
      ...
      return function(c) {
        var b = new Map;
        b.set("digits", ("string" == typeof c ? c : String(c)).match(a).map(Number));
        b.set("others", ("string" == typeof c ? c : String(c)).split(a));
        return b
      }
    }(),
    U = k(function(a, c, b) {
      var d = b.get("to").get("digits").map(function(d, f) {
        var g = b.get("from").get("digits")[f];
        if (g == d) return g;
        var h = d - g,
          g = G[b.get("easing")](c, g, h, a.get("duration"), b.get("frequency"));
    ...
    W = function() {
      ...
      return k(function(c, b, d) {
        ...
        c.forEach(function(a, c) {
          a.get("isTransformFunction") ? (e || (e = []), e.push(a.get("prop") + "(" + b[c] + ")")) : "opacity" == a.get("prop") ? d.style.opacity = b[c] : d.setAttribute(a.get("prop"), b[c])
        });
        e && (a || (a = "transform" in document.body.style ? "transform" : "-webkit-transform"), d.style[a] = e.join(" "))
      })
    }(),
    X = function() {
      var a = function(a, b) {
      ...
      return function(c, b) {
        return b.get("delay") ? setTimeout(function() {
          return a(c, b)
        }, b.get("delay")) : a(c, b)
      }
    }(),
    ...
    x = function(a) {
      ...
      X(function g(a) {
        if (l.has(d)) {
          ...
          a ? requestAnimationFrame(g) : (a = h(l), a["delete"](d), l = a, c.get("complete") && c.get("complete")(c.get("el")), c.get("loop") && Y(c))
        }
      }, c)
    };
  x.stop = function(a) {
...
var stickyElements = function() {
  ...
  var s = function() {
      function s(i) {
        ...
        t.classCallCheck(this, s), this.el = i, this.setOpts(e), this.setEvents()
      }
      return t.createClass(s, [{
        key: "setOpts",
        value: function(t) {
        ...
        value: function() {
          var t = this,
            s = this.el,
            i = ["enter", "leave", "move"];
          s._stickyEvents && (i.map(function(i) {
            t.pointer ? s.removeEventListener("pointer" + i, s._stickyEvents[i], !1) : s.removeEventListener("mouse" + i, s._stickyEvents[i], !1)
          }), s._stickyEvents = void 0), s._stickyEvents = {
            enter: function(s) {
              return t.onEnter(s)
            },
            leave: function(s) {
            ...
            t.pointer ? s.addEventListener("pointer" + i, s._stickyEvents[i], !1) : s.addEventListener("mouse" + i, s._stickyEvents[i], !1)
          })
        }
      }, {
        key: "setStickiness",
        value: function(t) {
          ...
          (t.stickiness || 0 === t.stickiness) && ("number" == typeof t.stickiness && (i.stickiness = {
            x: t.stickiness,
            y: t.stickiness
          }), (t.stickiness.x || 0 === t.stickiness.x) && (i.stickiness.x = t.stickiness.x), (t.stickiness.y || 0 === t.stickiness.y) && (i.stickiness.y = t.stickiness.y)), this.stickiness.x = s[Math.min(10, i.stickiness.x)], this.stickiness.y = s[Math.min(10, i.stickiness.y)]
        }
      }, {
        key: "getPositions",
        value: function(t, s) {
        ...
        value: function(t) {
          ...
          var i = this.el;
          animate.stop(i);
          var e = this.getPositions(this.positions.deltax, this.positions.deltay),
            n = e.posx,
            o = e.posy;
          (this.lastGripped = (new Date).getTime(), animate({
            el: i,
            translateX: [n, 0],
            translateY: [o, 0],
        ...
        value: function(t) {
          ...
          // console.log(Math.abs(this.positions.deltay), (this.positions.height / this.grip.y))
          if (isGrip.x && isGrip.y) {
            this.isGripped = true;
          }
          
          this.positions.deltax = -(this.positions.centerx * autoScaleInfo.zoom - clientX);
          this.positions.deltay = -(this.positions.centery* autoScaleInfo.zoom - clientY);
    ...
    i = function() {
      return function(t, i) {
        for (var e = [], n = [].slice.call(document.querySelectorAll(t)), o = 0; o < n.length; o++) e.push(new s(n[o], i));
        return e
      }
    }();
  return i
